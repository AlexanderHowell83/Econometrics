...
asdoc su lnGDPppp YSS YSI ColoFrance ColoSpain ColoDutch ColOther Colony if sample, save(DescriptiveStatistics.doc) replace title(Descriptive Statistics) font(TimesNewRoman) fs(12)
eststo e4: reg infmort YSS YSI ColoBrit Colony
